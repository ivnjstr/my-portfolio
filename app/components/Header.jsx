...
const Header = () => {
  return (
    <div id="home" className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
      ...
      <h3 className='flex items-end gap-2 text-xl md:text-2xl mb-3 font-Ovo'>Hi! I'm Ivan Jester <Image src={assets.hand_icon} className='w-6' alt=' waving hand'/></h3>

      <h1 className='text-3xl sm:text-6xl lg:text=[66px] font-Ovo'>frontend web developer based in Philippines</h1>

      <p className='max-w-2xl mx-auto font-Ovo'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Fuga, maiores?</p>
