    ...
    id='services' className='w-full px-[12%] py-10 scroll-mt-20'>
        ...
        className='grid grid-cols-(--grid-cols-auto) gap-6 my-10'> 
            {serviceData.map(({icon, title, description, link}, index) => (
                ...
                key={index} className='border border-gray-400 rounded-lg px-8 py-12 hover:shadow-(--box-shadow-black) cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 dark:hover:bg-darkHover dark:hover:shadow-(--box-shadow-white)'>
